    ...
    <div className="max-w-[1600px] mx-auto">
      ...
      <div className="lg:hidden mb-6">
        {!selectedClient ? (
          <GlassCard>
            <div className="relative mb-3">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-lg text-sm border border-[var(--glass-border)] focus:outline-none focus:border-blue-500/50 transition-colors"
          ...
          <button
            onClick={() => { setDetail(null); router.push(pathname, { scroll: false }); }}
            className="flex items-center gap-2 text-sm font-medium text-blue-500 mb-4"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* RIGHT: Detail panel */}
        <main className={`lg:col-span-8 xl:col-span-9 ${!selectedClient ? 'hidden lg:block' : ''}`}>
          {selectedClient ? (
            detailLoading ? (
              <GlassCard>
