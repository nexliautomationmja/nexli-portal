...
const STEPS: { key: WizardStep; label: string; num: number }[] = [
  { key: "script", label: "Script", num: 1 },
  { key: "assets", label: "Assets", num: 2 },
  ...
  const handleUploadAudio = useCallback(
    async (file: File) => {
      ...
      try {
        ...
        const res = await fetch("/api/dashboard/marketing/upload-audio", {
          method: "POST",
          body: formData,
        });
        ...
        setUploadError("Network error — audio upload failed.");
      } finally {
    ...
    <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: "var(--text-muted)" }}>
                Claude will write a natural UGC-style script based on your inputs.
              </p>
            </div>
      ...
      {step === "assets" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  Upload a photo of the person for the talking-head video. Front-facing,
                  well-lit works best.
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  Upload a recording of the script being read aloud. Clear audio,
              ...
              {audioUrl ? (
                ...
                <button
                  ...
                  className="w-full py-16 rounded-xl border-2 border-dashed border-[var(--glass-border)] flex flex-col items-center justify-center gap-2 hover:border-blue-500/30 transition-colors disabled:opacity-50"
                >
                  {uploadingAudio ? (
                    <div className="w-6 h-6 rounded-full border-2 border-blue-500/30 border-t-blue-500 animate-spin" />
                  ) : (
          ...
          {uploadError && (
            <p className="text-sm text-red-400 md:col-span-2">{uploadError}</p>
          )}
