...
const individual1040Sections: OrganizerSection[] = [
  ...
  // ── 10. Deductions ──
  {
    key: "deductions",
    title: "Deductions",
    description: "Enter amounts for any itemized deductions you paid during the tax year. Leave blank if not applicable.",
    fields: [
      { key: "medical_dental", label: "Medical and dental expenses", type: "currency", half: true },
      { key: "mortgage_interest", label: "Mortgage interest", type: "currency", half: true },
      { key: "state_local_taxes", label: "State and local income taxes", type: "currency", half: true },
      { key: "charitable_cash", label: "Donations to charity (cash)", type: "currency", half: true },
      { key: "sales_taxes", label: "Sales taxes", type: "currency", half: true },
      { key: "charitable_noncash", label: "Donations to charity (non-cash)", type: "currency", half: true },
      { key: "real_estate_taxes", label: "Real estate taxes", type: "currency", half: true },
      { key: "casualty_theft", label: "Casualty and theft losses", type: "currency", half: true },
      { key: "personal_property_taxes", label: "Personal property taxes", type: "currency", half: true },
      { key: "gambling_losses", label: "Gambling losses", type: "currency", half: true },
    ],
  },
